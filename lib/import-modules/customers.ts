...
export class CustomerImportModule implements ImportModule {
  name = 'Customers';
  description = 'Import customer records with contact and billing information';
  ...
  async importData(data: any[], fieldMappings: FieldMapping[], jobData: ImportJobData): Promise<ImportResult> {
    // TODO: Implement using legacy customer import logic
    return {
      success: true,
      processed: 0,
      errors: [],
